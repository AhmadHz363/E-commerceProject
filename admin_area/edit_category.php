...
if(isset($_GET['edit_category'])){
    ...
    $get_categories=" Select * from `categories` where cat_id=$edit_category";
...
if(isset($_POST['edit_cat'])){
    ...
    $update_query="UPDATE categories set cat_title= '$cat_title' where cat_id=$edit_category";
...
<div class="container mt-3">
     ...
     <form action="" method="post" class="text_center">
         ...
         <div class="form-outline mb-4 w-50 m-auto">
             ...
             <input type="submit" value="Update Category" class="btn btn-danger px-3 mb-3" name="edit_cat">
