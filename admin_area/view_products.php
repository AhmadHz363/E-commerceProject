...
<body>
    ...
    <table class="table table-bordered mt-5">
        ...
        <?php
            ...
            <td><?php 
            $get_count="Select * from `orders_pending` where prod_id=$product_id";
            ...
            <td><a href='index.php?delete_product=<?php echo $product_id;?>' class='text-danger'><i class='fa-solid fa-trash'></i></a></td></td>
            </tr>
            <?php
         }
            ?>
